...
\begin{figure}[!htbp]
\begin{center}
 \includegraphics[width=1.1\textwidth]{eclipse_editTrafo}
...
You can see that this main method is essentially the driver for a complete
...
\newline % inserted to bring itemize on the next page
...
filesystem depicted in \\ Fig.~\ref{eclipse:textDirectory}. You can also load the files from the following \href{https://github.com/eMoflon/emoflon/raw/master/handbookfiles/chapter05/myLibrary.zip}{\texttt{link}}.
