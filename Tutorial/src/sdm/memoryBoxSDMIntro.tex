...
learning box. How would a rule look like for moving a card from one partition to
...
deleted, retained and created. Applying $moveCard$ to a learning box according
to steps (1) -- (3) is depicted in Fig.~\ref{fig:rule_app_example}.
...
One last thing before we continue with our learning box; individual rules still
