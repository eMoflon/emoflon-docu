...
The SDMs for our memory box (e.g. grow or check) are examples for in-place transformations as they perform changes directly to a source model, transforming it destructively into the target model.
...
The memory box to dictionary transformation and vice-versa are examples of out-place transformations.
...
\input{m2t/03-mocaDictionaryMetaModel} 
 
\input{m2t/04-mocaTextToMocaTree}

\input{m2t/05-mocaMocaTreeToModel}

\input{m2t/06-mocaModelToMocaTree}

\input{m2t/07-mocaMocaTreeToText}
