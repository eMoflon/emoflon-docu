...
\begin{enumerate}
  \item[$\blacktriangleright$] Create the directory structure in
  \texttt{./instances/in} as depicted in Fig.~\ref{fig:moca-inputdata}.  Create
  each \texttt{dictionary} file as indicated and enter the contents from
  Table~\ref{moca-inputdata}.
  
  %\usepackage{graphics} is needed for \includegraphics
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.6\textwidth]{pics/moca/2TextToMocaTree/inputData}
