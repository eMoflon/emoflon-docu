\subsection{A string representation for our learning box}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{pics/sdmBilder/toString/sdm72.pdf}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{pics/sdmBilder/toString/sdm73.png}
...
\begin{figure}[ht]
   \centering
      ...
      \subfloat[Using a \texttt{AttributeValueExpression} as a return value.]{
        \includegraphics[width=0.45\textwidth]{pics/sdmBilder/toString/sdm75.png}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.77\textwidth]{pics/sdmBilder/toString/sdm76.pdf}
...
and write some tests. Before learning how to implement and integrate helper methods such as addToStringRep with generated code, let's first of all learn how to use inheritance and type down casting in Ecore/SDM.
