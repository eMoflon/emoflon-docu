...
\begin{figure}[!h]
	\centering
  \includegraphics[width=0.7\textwidth]{pics/eclipse_workingsets.png}
...
\begin{figure}[!h]
	\centering
  \includegraphics[width=0.7\textwidth]{pics/ea_firststart.png}
...
F5 (refresh).
You can see the progress in the lower right corner. (Figure
\ref{fig_eclipsebuilding})\\ 
All projects should be created and the code generator invoked
automatically\ldots\\

\begin{figure}[!h]
	\centering
  \includegraphics[width=0.7\textwidth]{pics/eclipse_building.png}
	\caption{Eclipse Building Workspace}
...
\begin{figure}[!h]
	\centering
  \includegraphics[width=0.7\textwidth]{pics/eclipse_testsuitimport.png}
