...
dynamic instance of a \texttt{Dictionary} named \texttt{target.xmi}. Make sure you persist the instance in
...
``LearningBox\-To\-Dictionary\-In\-te\-gra\-tion\-/src'' and click to open \texttt{TGGMain.java}. 
...
source \texttt{box} to a target \texttt{dictionary}, then backward from \texttt{dictionary} to \texttt{box}. As this is plain Java, you can adjust everything
freely as you wish.
