...
The first step to a completing any TGG is to model the correspondence component of your triples.\define{Link \\ Metamodel}This correspondence, or \emph{link
metamodel}, is made up of \emph{correspondence types}\define{Correspondence Types}which connect classes between the source and target metamodels. These special
