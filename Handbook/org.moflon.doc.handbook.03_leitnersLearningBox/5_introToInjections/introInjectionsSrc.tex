...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{eclipse_partialClassPartition}
...
When inside ``PartitionImpl.java", open the context menu and select ``eMoflon/Class <-> Injection" (Alt+Shift+E,W).
