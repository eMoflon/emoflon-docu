...
right corner of the window, and select ``Clear View'' (\Cref{eclipse:graphView_init}).
...
(\Cref{eclipse:graphView_typeGraph}). We have found that the ``Radial Layout'' works best for a view of this complexity. This might be confusing at first,
