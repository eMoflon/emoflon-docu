...
\item[$\blacktriangleright$]  To begin, navigate to ``New Metamodel Project''(\Cref{eclipse:newVisModelButton}) and start a new project named \texttt{Leit\-ners\-Learn\-ing\-Box} (\Cref{eclipse:newVisModel}). Open the empty \texttt{.eap} file in EA.
...
\item[$\blacktriangleright$] In EA, select your working set and press the ``Add a Package'' button (\Cref{ea:newPackage}). 
...
\item[$\blacktriangleright$] In the dialogue that pops up (\Cref{ea:newPackageName}), enter \texttt{LearningBoxLanguage} as the name of the new
...
\item[$\blacktriangleright$] Your \texttt{Project Browser} should now resemble \Cref{ea:newPackageComplete}.
...
\item[$\blacktriangleright$] Now select your new package and create a ``New Diagram'' (\Cref{ea:newDiagram}).
...
\item[$\blacktriangleright$] In the dialogue that appears (\Cref{ea:diagramType}), choose \texttt{eMoflon Ecore Diagrams} and press \texttt{OK}. 
...
\item[$\blacktriangleright$] After creating the new diagram, your  \texttt{Project Browser} should now resemble \Cref{ea:diagramComplete}. You'll notice
