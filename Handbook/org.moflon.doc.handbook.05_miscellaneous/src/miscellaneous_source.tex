...
\input{../7_eMoflonInAJar/eMoflonInAJarSrc}

\input{../5_shortcuts/shortcutsSrc}

\input{../8_LegacyCodeGen2/legacyCodeGen2}

\input{../9_CreatingAndUsingEnums/creatingAndUsingEnums}

\input{../10_convertTGGToMOSLTGG/convertTGGToMOSLTGG}
