...
guess, this is not the case as evidenced in the package browser (\Cref{ea:partiallyDeleted}).
...
action in the warning dialogue (\Cref{ea:deleteWarning}), and the element should no longer be in the project browser.
