...
As depicted in \Cref{fig:membox_illustration}, it consists of a series of compartments or partitions usually of increasing size. The content to be memorized
...
These ``rules'' are depicted by the green and red arrows in \Cref{fig:membox_illustration}. The basic idea is to repeat difficult cards as often as
...
words are easily placed in our limited short term memory and slowly move in our theoretically unlimited long term memory if practised often enough.
 ...
 \begin{figure}[htp]
 \begin{center}
   \includegraphics[width=0.5\textwidth]{../../org.moflon.doc.handbook.00_common/images/membox_illustration}
