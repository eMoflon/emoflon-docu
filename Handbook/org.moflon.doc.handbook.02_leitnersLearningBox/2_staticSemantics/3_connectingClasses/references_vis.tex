...
\item[$\blacktriangleright$] Within this dialogue, go to ``Role(s),'' and compare the relevant values in \Cref{ea:roles} for the \emph{source} 
...
\item[$\blacktriangleright$] Export your diagram to Eclipse and refresh your workspace. Your Ecore metamodel file in ``model/LearningBoxLanguage.ecore" should now resemble \Cref{eclipse:model_allClasses}.
