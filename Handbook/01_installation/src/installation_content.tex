% FORMAT THIS
{ \Huge Part I: Installing Stuff! }
% Main Task with this file: make sure all figures have worthwhile names

% This should be numbered as 'section 1.1' (since its reffering to the current workbook, not overall package)
% To keep reference to the entire handbook package, have the Part titles all at the top of the pages?
