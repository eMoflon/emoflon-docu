\newpage
\visHeader
\fancyfoot[R]{$\triangleright$ \hyperlink{validate common}{Next task}}
...
% One can set an eclipse preference that ensures that the workspace is always automatically refreshed even if one doesn't press F5.  Some people like this, some don't - we should mention and explain it here though...
