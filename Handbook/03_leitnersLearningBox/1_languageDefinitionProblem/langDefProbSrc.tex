...
Will your language be textual?  Visual?  This representation referred to as the \emph{Concrete Syntax}\marginpar{\emph{Concrete Syntax}} of a language and is basically an interface to end users who use the language. In the case of our learning box, Fig.~\ref{fig:membox_illustration} can be viewed as a possible concrete syntax.
