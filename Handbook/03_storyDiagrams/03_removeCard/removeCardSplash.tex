...
These patterns declare\define{Object \\ Variables}\emph{object variables}, place holders for actual objects in a model. During \emph{pattern matching}, objects
...
Patterns also declare \emph{link variables}\define{Link \\ Variables} to match references in the model. Given that
