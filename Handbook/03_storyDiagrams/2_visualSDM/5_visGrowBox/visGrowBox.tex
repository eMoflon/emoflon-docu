...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=\textwidth]{sdm57.pdf}
...
\note{\mbox{NACs}} match. In the theory of algebraic graph transformations \cite{EEPT06}, \mbox{NACs} can be complex graphs that are much more general and
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=\textwidth]{sdm65} 
...
the box (partitions usually get bigger) we call a helper function \note{MethodCallExpression} via a \emph{MethodCallExpression}. A MethodCallExpression is used
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.3\textwidth]{sdm66}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.9\textwidth]{sdm67}
