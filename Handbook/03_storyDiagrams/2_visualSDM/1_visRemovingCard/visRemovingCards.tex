...
then (2) \emph{click once} on the method \texttt{removeCard} to choose it (Fig.~\ref{fig:sdm_start}). \note{Create an SDM}  (3) \emph{Double-click} on the
chosen method to indicate that you want to implement it.

\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.4\textwidth]{sdm01RAW}
  \caption{Double-click a method to implement it.}  
  \label{fig:sdm_start}
\end{center}
\end{figure}
 
If you did everything right, a new \emph{activity diagram} should be created \note{Activity Diagram} with a cute little \emph{start node} labelled with the
signature of the method \note{Start Node} as depicted in Fig.~\ref{fig:sdm_skeleton}.  Inspect your project browser and note that an \texttt{SDM\_Container} has
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.9\textwidth]{sdm02RAW}
...
\clearpage Similar to quick linking which we learnt when creating our metamodel, a further fundamental gesture in EA is \emph{Quick \note{Quick Create} Create}.
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.5\textwidth]{sdm03RAW}
...
\note{Activity Edge} shall refer to the whole activity diagram simply as an \emph{activity} that always starts with a start node, terminates with a \emph{stop
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{sdm04RAW}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\textwidth]{sdm05RAW}
  \caption{Complete activity with a stop node.}  
  \label{fig:sdm_stop_node}
\end{center}
\end{figure}

If you did that right as well you should now have a complete activity that models the procedural \emph{control flow} of our method.  The semantics of our
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\textwidth]{sdm06RAW.pdf}
...
\begin{figure}[htpb]
\begin{center} 
  \includegraphics[width=0.45\textwidth]{sdm07RAW.png}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{sdm09RAW}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{sdm10RAW}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.55\textwidth]{sdm11RAW}
...
\begin{figure}[htp]
\begin{center} 
 \includegraphics[width=0.6\textwidth]{sdm12RAW}
...
\begin{quote}\texttt{aPartition.removeCard(aCard).invert()}\end{quote} In any case, a return value for an SDM can be specified in the stop node. \note{Return
Values} As depicted in Fig.~\ref{fig:stop_node_return_value}, double-click the stop node to prompt the \texttt{Edit StopNode} dialogue. \note{Expressions} In
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.95\textwidth]{sdm14RAW}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.7\textwidth]{sdm15}
