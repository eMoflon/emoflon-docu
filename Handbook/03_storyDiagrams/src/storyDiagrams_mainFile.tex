...
\usepackage{makeidx}
\makeindex
\addto\captionsenglish{\renewcommand{\indexname}{MOSL Syntax Index}}
...
% These words should appear in glossary and will appear in reference index
\newcommand{\defineMOSL}[1]{\define{#1}\index{#1}}

% Textual Syntax formatting (quote environment)
...
% Forward jump links to Visual/Textual sections
...
% -- Quick author editing mark; remove from final ---
...
% Reference of all MOSL syntaxes used to date
% \input{storyDiagrams_quickSyntaxReference}

% ! KNOWN TEXCLIPSE BUG: If you make edits to Index (i.e., add entries), may not load in pdf/sumatra until you clean the project.
% Small index list of eMoflon expression type defintions
% \printindex
