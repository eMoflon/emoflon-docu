...
\item[$\blacktriangleright$] Download and install Eclipse \EclipseVersion for modelling, which is called ``\textbf{Eclipse Modeling Tools}'' from \EclipseDownloadLink{} (\Cref{eclipseDownload}).\footnote{Please
...
\emph{Hint:} To inform you about new updates, we provide some mailing lists for you: \linkto{http://www.emoflon.org/emoflon/mailing-lists/}
\end{itemize}
