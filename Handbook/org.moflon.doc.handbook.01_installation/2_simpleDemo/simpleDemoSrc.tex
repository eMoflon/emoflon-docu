...
Navigate to the \menuPath{Git} perspective in Eclipse (\menuPath{Window \menuSep Perspective \menuSep Open Perspective \menuSep Other\dots}), right-click your working copy \entity{emoflon-examples} and choose \menuPath{Delete Repository...}.
