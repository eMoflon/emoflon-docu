...
open, or select will be given as \texttt{command}.} and choose \texttt{eMoflon} (\Cref{eclipse:openPerspective}).
...
\item[$\blacktriangleright$]  Another button in the new action set is ``View and configure logging'' represented by an \texttt{L} (\Cref{eclipse:logger}).
