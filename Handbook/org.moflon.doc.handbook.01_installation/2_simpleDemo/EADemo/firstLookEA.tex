...
\item[$\blacktriangleright$] Double-click \filename{Demo.eap} to start EA, and choose \filename{Ultimate} when starting EA for the first time.
...
This is where you can validate and export your complete project to Eclipse by pressing \filename{All} (\Cref{ea:controlPanel}).
%
\begin{figure}[htbp]
	\centering
...
\item[$\blacktriangleright$] Switch back to Eclipse, choose your metamodel project, and press \filename{F5} to refresh. 
The export from EA places all required files in a hidden folder (\filename{.temp}) in the project.
A new, third project named \filename{org.moflon.demo.doublelinkedlist} is now being created.
...
\end{figure}
%
\item[$\blacktriangleright$] Now, right-click \filename{org.moflon.demo.doublelinkedlist} and choose \menuPath{eMoflon \menuSep Build} (or use the shortcut \filename{Alt+Shift+E,B}\footnote{First press \filename{Alt+Shift+E}, release, and press \filename{B}.
By default, most shortcuts eMoflon start with \filename{Alt+Shift+E}.}).
