...
\item The three asterisks signal that the project still needs to be built (\Cref{eclipse:dirty-project}).
%
\begin{figure}[htbp]
    \centering
...
\end{figure}
%
\item Now, right-click \entity{org.moflon.demo.doublelinkedlist} and choose \menuPath{eMoflon \menuSep Build} (or use the shortcut \entity{Alt+Shift+E,B}\footnote{First press \entity{Alt+Shift+E}, release, and press \entity{B}.
