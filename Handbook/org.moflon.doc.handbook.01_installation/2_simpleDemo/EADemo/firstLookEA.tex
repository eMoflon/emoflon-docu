...
\item[$\blacktriangleright$] In EA, select ``Extensions/Add-In Windows'' (\Cref{ea:validate_dropdown}). This will activate our tool's full
...
eMoflon's functionality. This is where you can validate and export your complete project to Eclipse by pressing \texttt{All} (\Cref{ea:controlPanel}).
...
\item[$\blacktriangleright$] The three asterisks (\Cref{eclipse:dirty-project}) signal that the project still needs to be built.
...
You should be able to monitor the progress with the green bar in the lower right corner (\Cref{eclipse:build}). Pressing the
