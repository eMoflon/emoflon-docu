...
\begin{stepbystep}
\item Locate and open \texttt{IndexToLevel.java} under \filename{src/csp.constraints} in \moslTggCode{Lear\-ningBoxToDictionaryIntegration}.
...
\lstinputlisting[language=Java,label={code:indexToLevel},caption={Implementation of our custom \texttt{IndexToLevel} constraint}]{../4_rules/listings/IndexToLevel.java}
