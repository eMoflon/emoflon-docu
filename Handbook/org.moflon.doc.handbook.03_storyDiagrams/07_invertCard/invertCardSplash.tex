...
This next SDM \emph{inverts} a card by swapping its back and face values (\Cref{fig:goal_invert}). This therefore ``turns a card around'' in the learning
...
\begin{figure}[htbp]
	\centering
    \includegraphics[width=0.4\textwidth]{../../org.moflon.doc.handbook.03_storyDiagrams/07_invertCard/goal_invert.pdf}
...
\input{../../org.moflon.doc.handbook.03_storyDiagrams/07_invertCard/visTurnCard}

\input{../../org.moflon.doc.handbook.03_storyDiagrams/07_invertCard/invertClose}
