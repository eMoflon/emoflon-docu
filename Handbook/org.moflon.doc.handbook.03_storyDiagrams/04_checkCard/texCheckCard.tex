...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.6\textwidth]{eclipse_checkPackageExplorer}
...
any\_literal := SINGLE\_QUOTED\_STRING\\
}
...
\lstinputlisting[style=eclass, firstline=17, lastline=29, firstnumber=17, label=eclipse:finalMethod,caption={Completed control flow for \texttt{check} with an if/else construct}] {../04_checkCard/texCheCode/Partition.txt} 
