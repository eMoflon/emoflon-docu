...
in \Cref{fig:membox_depiction}, a box consists of a series of partitions with a strict set of rules. The contents to be memorized are written on little
...
(\Cref{eclipse:downloadWizard}).

\begin{figure}[htbp]
	\centering
  \includegraphics[width=0.9\textwidth]{eclipse_downloadWizard}
...
\vspace*{0.5cm}
%
%\item If your package explorer does not resemble ours in \Cref{eclipse:workingSets} with at least two distinct nodes, select the
