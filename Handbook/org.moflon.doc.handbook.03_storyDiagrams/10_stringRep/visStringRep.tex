...
\item You can see in the \texttt{Method} statement that a \texttt{Card} parameter is required. For this double click on the field below and enter the values like in \Cref{ea:editStatement2}. Now we included \texttt{card} so we may pass the object variable to the method.
...
\item Take some time to compare and reflect on the complete SDM as depicted in \Cref{ea:sdm_tostringComplete}.  The idea was to
