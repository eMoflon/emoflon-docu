...
which starts at (approximately) line 207 (\Cref{eclipse:initBoxImpl}). This is the generated \emph{statement node} code and, as you can see, all it does is
...
Go to \texttt{initializeBox}, it should look like \Cref{eclipse:initBoxDecl}.
