...
\item[$\blacktriangleright$] To begin, select the start node, and note the small black arrow that appears (\Cref{ea:sdm_quicklink}). 
...
\item[$\blacktriangleright$] As illustrated in \Cref{ea:sdm_new_activity_node}, choose \texttt{Append StoryNode} to create a \emph{Story Node}.
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.9\textwidth]{ea_sdmNewObjVar}
...
\begin{figure}[htpb]
\begin{center}
  \includegraphics[width=0.75\textwidth]{ea_sdmCreateLinkVar}
...
\begin{figure}[h!]
\begin{center} 
 \includegraphics[width=0.75\textwidth]{ea_sdmBindLink}
...
\item[$\blacktriangleright$] If you're unable to export or generate code successfully, compare your SDM carefully with \Cref{ea:sdm_complete_control_flow}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{ea_sdmRemoveSDM_findInProjectBrowser}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{ea_sdmRemoveSDM_methodSelected}
