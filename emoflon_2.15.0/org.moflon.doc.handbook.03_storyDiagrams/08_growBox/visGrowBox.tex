...
\item[$\blacktriangleright$] Start by creating the simple story pattern depicted in \Cref{ea:sdm_growContext}. This matches the box and \emph{any} two
...
\item[$\blacktriangleright$] Finally, complete the pattern so that it closely resembles \Cref{ea:sdm_firstLastPartitions}. 
...
\item[$\blacktriangleright$] If you've done everything right, your SDM should now closely resemble \Cref{ea:growComplete}. As usual, try to export,
