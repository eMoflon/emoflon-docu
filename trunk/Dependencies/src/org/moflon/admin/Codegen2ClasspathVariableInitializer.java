...
public class Codegen2ClasspathVariableInitializer extends ClasspathVariableInitializer
{
   ...
   {
      URL urlPath = Activator.getDefault().getPathRelToPlugIn("/lib/RuntimeTools.jar", Activator.PLUGIN_ID);
