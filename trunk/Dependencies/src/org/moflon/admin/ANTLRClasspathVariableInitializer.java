...
public class ANTLRClasspathVariableInitializer extends ClasspathVariableInitializer
{

   @Override
   public void initialize(String variable)
   {
      URL urlPath = Activator.getDefault().getPathRelToPlugIn("/lib/antlr-3.3-complete.jar", Activator.PLUGIN_ID);
