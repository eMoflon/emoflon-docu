...
public class EADebuggingSocketTraceStrategy extends AbstractEaTraceStrategy
{
	...
	{
		if (state instanceof Sending)
			super.logLinkCreation(c, stw, sourceNodeName, sourceNodeType, sourceNodeValue, sourceRoleName, targetNodeName, targetNodeType,
					targetNodeValue, targetRoleName);
	}
	...
	{
		if (state instanceof Sending)
			super.logLinkDeletion(c, stw, sourceRoleName, sourceNodeType, sourceNodeValue, sourceNodeName, targetNodeName, targetNodeType,
					targetNodeValue, targetRoleName);
	}
