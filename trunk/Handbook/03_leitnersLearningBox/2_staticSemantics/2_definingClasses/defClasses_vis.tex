...
Fig.~\ref{fig:all_eclasses}. These will be the main types for our learning box metamodel.

\vspace{0.5cm}

\item[$\blacktriangleright$] Right-click on \texttt{Box} to activate the context menu, and choose ``Features \& Properties/Attributes..''
...
\item[$\blacktriangleright$] Add attributes to each class until your workspace resembles Fig.~\ref{fig:attribute_completed}.

\vspace{0.5cm}

\item[$\blacktriangleright$] Save the file, then export your updated diagram to Eclipse. You'll be able to see the changes in the \texttt{.ecore} model file, where
