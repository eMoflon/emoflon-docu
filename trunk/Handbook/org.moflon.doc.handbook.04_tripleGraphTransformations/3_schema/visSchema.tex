...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=\textwidth]{ea_LearningBoxIntegrationPackage}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=\textwidth]{ea_newTGGSchema}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.6\textwidth]{ea_TGGSourceTarget}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.7\textwidth]{ea_browserPostDiagram}
