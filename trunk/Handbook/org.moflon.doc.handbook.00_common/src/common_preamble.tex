...
\def\emoflonURL{contact@emoflon.org}
\def\versionNumber{2.15.0}
\def\eMoflonUpdateSite{\url{http://tiny.cc/emoflon-rel-update-site}}
\def\eMoflonEAAddin{\url{http://tiny.cc/emoflon-rel-eaaddin}}
...
\newcommand{\eMoflonContact}{\href{mailto:\emoflonURL}{\emoflonURL}}
