...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=1.1\textwidth]{ea_extractStoryPattern}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.5\textwidth]{sdm_promoteCardProjBrowser}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.9\textwidth]{ea_sdmCheckComplete}
