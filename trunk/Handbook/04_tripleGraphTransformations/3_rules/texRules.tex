...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.4\textwidth]{eclipse_cardToEntry_sourceOVs}
...
\item[$\blacktriangleright$] Specify the rule within the \texttt{contraints} scope via: \syntax{indexToLevel[BB,BF,FB](EInt, EString)} We will discuss what
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{eclipse_cardToEntry_complete}
