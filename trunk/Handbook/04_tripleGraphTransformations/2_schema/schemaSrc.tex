...
correspondence component of your triples.\define{Link \\ Metamodel}This correspondence or \emph{link metamodel}, is made up of \emph{correspondence
types}\define{Correspondence Types}which connect classes between the source and target metamodels. These special types can be thought of as traceability
links. They can help you understand why objects were created.

While the link metamodel is really just a standard metamodel, we use a slightly different naming conventions and concrete syntax to represent it.\define{TGG
