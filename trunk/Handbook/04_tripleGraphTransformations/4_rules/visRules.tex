...
\begin{figure}[h!]
\begin{center}
  \includegraphics[width=0.9\textwidth]{ea_TGGConstraintDependency}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=\textwidth]{ea_BoxToDictionaryComplete}
...
\begin{figure}[htbp]
\begin{center}
 \includegraphics[width=0.9\textwidth]{ea_deriveCardToEntry}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{ea_cardToEntryRuleFirstConstraints}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=\textwidth]{ea_CardToEntryRuleComplete}
