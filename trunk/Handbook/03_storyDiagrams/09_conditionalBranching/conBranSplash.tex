...
node}.\define{Statement Node}These are only used to guarantee a specific action between \emph{activity nodes}, and cannot appear indepedently. They can however,
