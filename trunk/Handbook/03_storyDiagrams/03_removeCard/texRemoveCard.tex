...
\emph{ObjectVariableExpression}.\define{ObjectVariable\-Expression}This expression implicitly refers to object variables from the preceding story
node. In \texttt{removeCard}'s case, the returned object refers to the \texttt{card} from the pattern.
