...
\defineMOSL{ObjectVariable\-Expression}. This expression implicitly refers to object variables from the preceding story node. In \texttt{removeCard}'s case, the
...
\item[$\blacktriangleright$] In summary, any \emph{outgoing link variable}\defineMOSL{Outgoing~Link Var\-i\-able} follows this syntax:
