...
can use eMoflon's auto-complete feature here! Press \texttt{Ctrl + spacebar} on an empty line, then select the pattern template to establish
\texttt{deleteSingleCard}.
