...
context menu anywhere in the diagram by pressing \texttt{space}.
...
As suggessted by its name, a \emph{ParameterExpression} is an expression that exclusively access method parameters. Given that \texttt{card} is the sole
...
We're nearly done! As you can see, eMoflon uses a series of dialogues to activate a simple context-sensitive expression language for specifying  values. In the
