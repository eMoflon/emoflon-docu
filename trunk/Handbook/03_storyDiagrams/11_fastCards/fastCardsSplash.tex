...
\jumpDual{fastCard vis}{fastCard tex}
  
\input{../11_fastCards/visFastCard}

\input{../11_fastCards/texFastCard}

\input{../11_fastCards/expressionDiscussion}

\input{../11_fastCards/GUIFastCard}
