...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=\textwidth]{fastcard_controlflow.pdf}
...
via \emph{BindingExpressions} or just \emph{Bindings}. A binding can be specified for a \emph{bound} object variable \note{Bindings} and represents the final
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.35\textwidth]{fastcard_bindingexp}
