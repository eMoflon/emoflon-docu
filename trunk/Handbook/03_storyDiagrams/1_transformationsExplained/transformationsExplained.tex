...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.6\textwidth]{rule_application}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.9\textwidth]{rule_example}
...
\begin{figure}[htp] 
\begin{center}
  \includegraphics[width=\textwidth]{rule_app_example}
...
\fancyfoot[R]{ $\triangleright$ \hyperlink{visSDM start}{First visual task} \\ $\triangleright$ \hyperlink{texSDM start}{First textual step} }
