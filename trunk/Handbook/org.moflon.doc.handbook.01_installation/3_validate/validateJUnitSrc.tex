...
\item[$\blacktriangleright$] In Eclipse, choose \texttt{Working Sets} as your top level element in the package explorer (\Cref{eclipse:topLevel}), as we use
...
Congratulations!  If you see a green bar  (\Cref{eclipse:passedTest}), then everything has been set up correctly and you are now ready to start
metamodelling!
