...
\item[$\blacktriangleright$] Select \menuPath{Tools/Options/Themes} in EA, and set Diagram Theme to \texttt{Enterprise Architect 10}.

\item[$\blacktriangleright$] Next, proceed to \menuPath{Gradients and Background} and set \menuPath{Gradient} and \menuPath{Fill} to \entity{White} (\Cref{ea:paperAndElementFill}). 
...
\item[$\blacktriangleright$] In the \menuPath{Standard Colors} tab, and set your colours to reflect \Cref{ea:standardColoursEA}.
