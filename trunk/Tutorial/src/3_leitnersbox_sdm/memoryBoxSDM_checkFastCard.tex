...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.57\textwidth]{pics/sdmBilder/bindings/fastcard_controlflow}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.7\textwidth]{pics/sdmBilder/bindings/fastcard_bindingexp.png}
