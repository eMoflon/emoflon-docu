...
\item[$\blacktriangleright$] Now right-click on the project \texttt{DictionaryCodeAdapter} and choose ``Add Parser/Unparser'' from the eMoflon context menu (Fig \ref{fig:moca-1-AddParserAndUnparserWizard}).
