...
principle is called \emph{unification},\define{Unification}and has many advantages. If everything is a model, a metamodel that
defines (at least a part of)\define{Modelling Language} a language must be a model itself. This means that it conforms to some
