...
With these few basic concepts, we can now introduce a further and central concept in metamodelling, the \emph{metamodel},\define{Metamodel}which is basically
...
(OO) paradigm, in metamodelling, everything is a model! This principle is called \emph{unification},\define{Unification} and has many
