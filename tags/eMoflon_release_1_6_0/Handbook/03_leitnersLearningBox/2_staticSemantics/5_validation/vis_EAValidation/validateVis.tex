...
display a new output window, as depicted in Fig.~\ref{ea:validation_output}. Many users prefer this interface, as it provides quick access to all of eMoflon's
...
\item[$\blacktriangleright$] Ensure that your metamodel closely resembles Fig.~\ref{ea:metamodel_complete} again, and that there are no error messages before
proceeding.
