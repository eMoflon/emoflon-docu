...
\texttt{true} for the same reason as in \texttt{check} earlier. Compare the pattern in \Cref{ea:promoteFastCardPattern} to \Cref{ea:sdm_check_complete_activity_node, ea:sdm_check_complete_penalize}, the
