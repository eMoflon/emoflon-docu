...
\begin{enumerate}
  ...
  (\Cref{fig:advanced-topics-eaSVN-rightclick}).
...
\newpage
  ...
  SlikSVN>$\backslash$bin$\backslash$svn.exe")}. Press ``Save'' and close the dialogue (\Cref{fig:advanced-topics-eaSVN-variable}). If the dialogue closes
...
mirrors the package structure in EA (\Cref{fig:advanced-topics-eaSVN-addPackage}). This process has to be repeated \emph{for all sub-packages} as soon as
